...
![training-with-mini-batch-gradient-descent](https://raw.githubusercontent.com/bighuang624/Andrew-Ng-Deep-Learning-notes/master/Improving_Deep_Neural_Networks/training-with-mini-batch-gradient-descent.png)
...
![choosing-mini-batch-size](https://raw.githubusercontent.com/bighuang624/Andrew-Ng-Deep-Learning-notes/master/Improving_Deep_Neural_Networks/choosing-mini-batch-size.png)
...
![Exponentially-weight-average](https://raw.githubusercontent.com/bighuang624/Andrew-Ng-Deep-Learning-notes/master/Improving_Deep_Neural_Networks/Exponentially-weight-average.png)
...
$$\frac{v\_t}{1-\beta^t} = \beta v\_{t-1} + (1 - \beta)\theta_t$$
...
![Gradient-Descent-with-Momentum](https://raw.githubusercontent.com/bighuang624/Andrew-Ng-Deep-Learning-notes/master/Improving_Deep_Neural_Networks/Gradient-Descent-with-Momentum.png)
...
将成本函数想象为一个碗状，从顶部开始运动的小球向下滚，其中 dw，db 想象成球的加速度；而 v_dw，v_db 相当于速度。
...
当 dw 或 db 较大时，`(dw)^2`、`(db)^2`会较大，进而`s_dw`、`s_db`也会较大，最终使得
...
![RMSProp](https://raw.githubusercontent.com/bighuang624/Andrew-Ng-Deep-Learning-notes/master/Improving_Deep_Neural_Networks/RMSProp.png)
...
![saddle](https://raw.githubusercontent.com/bighuang624/Andrew-Ng-Deep-Learning-notes/master/Improving_Deep_Neural_Networks/saddle.png)

当我们建立一个神经网络时，通常梯度为零的点是上图所示的**鞍点（saddle）**，而非局部最小值。因为在一个具有高维度空间的成本函数中，如果梯度为 0，那么在每个方向，成本函数或是凸函数，或是凹函数。而所有维度均需要是凹函数的概率极小，因此在低维度的局部最优点的情况并不适用于高维度。
